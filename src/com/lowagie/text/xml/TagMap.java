...
public class TagMap extends HashMap {
	...
	class AttributeHandler extends DefaultHandler {
		...
		/**
		 * Constructs a new SAXiTextHandler that will translate all the events triggered by the
		 * parser to actions on the <CODE>Document</CODE>-object.
		 *
		 ...
		 * @param lname the local name (without prefix), or the empty string if Namespace processing
