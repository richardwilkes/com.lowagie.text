 ...
 * representation of every Element added to this Document will be written to the outputstream.
 * </P>
 */
...
public class PdfWriter extends DocWriter implements PdfViewerPreferences, PdfVersion, PdfDocumentActions, PdfPageActions, PdfXConformance, PdfRunDirection, PdfAnnotations {
	...
	public static class PdfBody {
		 ...
		 * object to an <CODE>ArrayList</CODE> that will be used to build the Cross-reference Table.
		 *
		 ...
		 * <CODE>ref</CODE>, containing the given <CODE>PdfObject</CODE>. It also adds a
		 * <CODE>PdfCrossReference</CODE> for this object to an <CODE>ArrayList</CODE> that will be
		 * used to build the Cross-reference Table.
		 *
		 * @param object a <CODE>PdfObject</CODE>
	...
	/**
	 * Sets the initial leading for the PDF document. This has to be done before the document is
	 * opened.
	 *
	...
	/**
	 * Use this method to make sure the page tree has a linear structure (every leave is attached
	 * directly to the root). Use this method to allow page reordering with method reorderPages.
	 */
	...
	/**
	 * Use this method to reorder the pages in the document. A <CODE>null</CODE> argument value only
	 * returns the number of pages to process. It is advisable to issue a
	 * <CODE>Document.newPage()</CODE> before using this method.
	 *
	 * @return the total number of pages
	 * @param order an array with the new page sequence. It must have the same size as the number of
	 *            pages.
	...
	/**
	 * Gets the pagenumber of this document. This number can be different from the real pagenumber,
	 ...
	 *
	 * @param tabs Can be PdfName.R, PdfName.C or PdfName.S. Since the Adobe Extensions Level 3, it
	 *            can also be PdfName.A or PdfName.W
	 * @since 2.1.5
	 */
	...
	public void setPageEvent(PdfPageEvent event) {
		if (event == null) {
			...
			pageEvent = event;
		} else if (pageEvent instanceof PdfPageEventForwarder) {
	...
	/**
	 * Signals that the <CODE>Document</CODE> has been opened and that <CODE>Elements</CODE> can be
	 * added.
	 * <P>
	...
	/**
	 * Signals that the <CODE>Document</CODE> was closed and that no other <CODE>Elements</CODE>
	 * will be added.
	 * <P>
	...
	public void close() {
		if (open) {
			if (currentPageNumber - 1 != pageReferences.size()) {
				throw new RuntimeException("The page " + pageReferences.size() + " was requested but the document has only " + (currentPageNumber - 1) + " pages.");
			}
			pdf.close();
			try {
	...
	/**
	 * Use this method to add a JavaScript action at the document level. When the document opens,
	 * all this JavaScript runs.
	 *
	 ...
	 * @param unicode select JavaScript unicode. Note that the internal Acrobat JavaScript engine
	 *            does not support unicode, so this may or may not work for you
	 */
	...
	/**
	 * Use this method to adds a JavaScript action at the document level. When the document opens,
	 * all this JavaScript runs.
	 *
	 * @param code the JavaScript code
	 */
	 ...
	 * @param fileStore an array with the file. If it's <CODE>null</CODE> the file will be read from
	 *            the disk
	 * @param file the path to the file. It will only be used if <CODE>fileStore</CODE> is not
	 *            <CODE>null</CODE>
	 ...
	 * @param outputCondition a value, "PDFA/A" to force GTS_PDFA1, otherwise cued by
	 *            pdfxConformance.
	 ...
	 * @param checkExistence <CODE>true</CODE> to just check for the existence of a valid output
	 *            intent dictionary, <CODE>false</CODE> to insert the dictionary if it exists
	 * @throws IOException on error
	...
	/**
	 * @deprecated As of iText 2.0.7, use {@link #ALLOW_PRINTING} instead. Scheduled for removal at
	 *             or after 2.2.0
	 */
	@Deprecated
	public static final int		AllowPrinting				= ALLOW_PRINTING;
	/**
	 * @deprecated As of iText 2.0.7, use {@link #ALLOW_MODIFY_CONTENTS} instead. Scheduled for
	 *             removal at or after 2.2.0
	 */
	@Deprecated
	public static final int		AllowModifyContents			= ALLOW_MODIFY_CONTENTS;
	/**
	 * @deprecated As of iText 2.0.7, use {@link #ALLOW_COPY} instead. Scheduled for removal at or
	 *             after 2.2.0
	 */
	@Deprecated
	public static final int		AllowCopy					= ALLOW_COPY;
	/**
	 * @deprecated As of iText 2.0.7, use {@link #ALLOW_MODIFY_ANNOTATIONS} instead. Scheduled for
	 *             removal at or after 2.2.0
	 */
	@Deprecated
	public static final int		AllowModifyAnnotations		= ALLOW_MODIFY_ANNOTATIONS;
	/**
	 * @deprecated As of iText 2.0.7, use {@link #ALLOW_FILL_IN} instead. Scheduled for removal at
	 *             or after 2.2.0
	 */
	@Deprecated
	public static final int		AllowFillIn					= ALLOW_FILL_IN;
	/**
	 * @deprecated As of iText 2.0.7, use {@link #ALLOW_SCREENREADERS} instead. Scheduled for
	 *             removal at or after 2.2.0
	 */
	@Deprecated
	public static final int		AllowScreenReaders			= ALLOW_SCREENREADERS;
	/**
	 * @deprecated As of iText 2.0.7, use {@link #ALLOW_ASSEMBLY} instead. Scheduled for removal at
	 *             or after 2.2.0
	 */
	@Deprecated
	public static final int		AllowAssembly				= ALLOW_ASSEMBLY;
	/**
	 * @deprecated As of iText 2.0.7, use {@link #ALLOW_DEGRADED_PRINTING} instead. Scheduled for
	 *             removal at or after 2.2.0
	 */
	@Deprecated
	...
	/**
	 * @deprecated As of iText 2.0.7, use {@link #STANDARD_ENCRYPTION_40} instead. Scheduled for
	 *             removal at or after 2.2.0
	 */
	@Deprecated
	public static final boolean	STRENGTH40BITS				= false;
	/**
	 * @deprecated As of iText 2.0.7, use {@link #STANDARD_ENCRYPTION_128} instead. Scheduled for
	 *             removal at or after 2.2.0
	 */
	@Deprecated
	...
	/**
	 * Use this method to set the document's compression to the PDF 1.5 mode with object streams and
	 * xref streams. It can be set at any time but once set it can't be unset.
	 * <p>
	...
	/**
	 * Use this method to releases the memory used by a template. This method writes the template to
	 * the output. The template can still be added to any content but changes to the template itself
	...
	/**
	 * Use this method to get a page from other PDF document. The page can be used as any other
	 * PdfTemplate. Note that calling this method more than once with the same parameters will
	...
	/**
	 * Use this method to writes the reader to the document and free the memory used by it. The main
	 * use is when concatenating multiple documents to keep the memory usage restricted to the
	 * current appending document.
	 *
	...
	/**
	 * Use this method to gets the current document size. This size only includes the data already
	 * written to the output stream, it does not include templates or fonts. It is useful if used
	 * with <CODE>freeReader()</CODE> when concatenating many documents and an idea of the current
	 * size is needed.
	 *
	...
	/**
	 * Gets the structure tree root. If the document is not marked for tagging it will return
	 * <CODE>null</CODE>.
	 *
	...
	/**
	 * Use this method to get the <B>Optional Content Properties Dictionary</B>. Each call fills the
	 * dictionary with the current layer state. It's advisable to only call this method right before
	 * close and do any modifications at that time.
	 *
	 ...
	 * follow a "radio button" paradigm. That is, the state of at most one optional content group in
	 * the array should be ON at a time: if one group is turned ON, all others must be turned OFF.
	 *
	...
	/**
	 * Use this method to lock an optional content group. The state of a locked group cannot be
	 * changed through the user interface of a viewer application. Producers can use this entry to
	 * prevent the visibility of content that depends on these groups from being changed by users.
	 *
	...
	/**
	 * Use this method to set the crop box. The crop box should not be rotated even if the page is
	 * rotated. This change only takes effect in the next page.
	 *
	...
	/**
	 * Use this method to set the page box sizes. Allowed names are: "crop", "trim", "art" and
	 * "bleed".
	 *
	...
	/**
	 * Use this method to make sure a page is added, even if it's empty. If you use
	 * setPageEmpty(false), invoking newPage() after a blank page will add a newPage.
	 *
	...
	/**
	 * A group attributes dictionary specifying the attributes of the page's page group for use in
	...
	/**
	 * The ratio between the extra word spacing and the extra character spacing. Extra word spacing
	 * will grow <CODE>ratio</CODE> times more than extra character spacing.
	 */
	...
	/**
	 * Use this method to set the ratio between the extra word spacing and the extra character
	 * spacing when the text is fully justified. Extra word spacing will grow
	 * <CODE>spaceCharRatio</CODE> times more than extra character spacing. If the ratio is
	...
	/**
	 * Use this method to set the run direction. This is only used as a placeholder as it does not
	 * affect anything.
	 *
	...
	/**
	 * Use this method to set the user unit. A UserUnit is a value that defines the default user
	 * space unit. The minimum UserUnit is 1 (1 unit = 1/72 inch). The maximum UserUnit is 75,000.
	 * Note that this userunit only works starting with PDF1.6!
	 *
	...
	/**
	 * Use this method to set the image sequence, so that it follows the text in strict order (or
	 * not).
	 *
	...
	/**
	 * Use this method to adds an image to the document but not to the page resources. It is used
	 * with templates and <CODE>Document.add(Image)</CODE>. Use this method only if you know what
	 * you're doing!
	 *
	...
	/**
	 * Gets an indirect reference to a JBIG2 Globals stream. Adds the stream if it hasn't already
	...
	/**
	 * Gets the flag indicating the presence of structure elements that contain user properties
	 * attributes.
	 *
	...
	/**
	 * Sets the flag indicating the presence of structure elements that contain user properties
	 * attributes.
	 *
	...
	/**
	 * Sets the transparency blending colorspace to RGB. The default blending colorspace is CMYK and
	 * will result in faded colors in the screen and in printing. Calling this method will return
	 * the RGB colors to what is expected. The RGB blending will be applied to all subsequent pages
	 * until other value is set. Note that this is a generic solution that may not work in all
	 * cases.
	 *
	 * @param rgbTransparencyBlending <code>true</code> to set the transparency blending colorspace
	 *            to RGB, <code>false</code> to use the default blending colorspace
	 * @since 2.1.0
	 */
