 ...
 * <P>
 * An array is a sequence of PDF objects. An array may contain a mixture of object types. An array
 * is written as a left square bracket ([), followed by a sequence of objects, followed by a right
 * square bracket (]).<BR>
...
public class PdfArray extends PdfObject {
	...
	/**
	 * Constructs a <CODE>PdfArray</CODE>-object, containing all <CODE>float</CODE> values in a
	 * specified array. The <CODE>float</CODE> values are internally converted to
	...
	/**
	 * Constructs a <CODE>PdfArray</CODE>-object, containing all <CODE>int</CODE> values in a
	 * specified array. The <CODE>int</CODE> values are internally converted to
	 * <CODE>PdfNumber</CODE> objects.
	 *
	...
	/**
	 * Constructs an <CODE>PdfArray</CODE>-object, containing all <CODE>PdfObject</CODE>s in a
	 * specified <CODE>PdfArray</CODE>.
	 *
	...
	/**
	 * Returns a string representation of this <CODE>PdfArray</CODE>. The string representation
	...
	/**
	 * Adds a <CODE>PdfObject</CODE> to the end of the <CODE>PdfArray</CODE>. The
	 * <CODE>PdfObject</CODE> will be the last element.
	 *
	...
	/**
	 * Adds an array of <CODE>float</CODE> values to end of the <CODE>PdfArray</CODE>. The values
	 * will be the last elements. The <CODE>float</CODE> values are internally converted to
	 * <CODE>PdfNumber</CODE> objects.
	 *
	...
	/**
	 * Adds an array of <CODE>int</CODE> values to end of the <CODE>PdfArray</CODE>. The values will
	 * be the last elements. The <CODE>int</CODE> values are internally converted to
	 * <CODE>PdfNumber</CODE> objects.
	 *
	...
	/**
	 * Inserts the specified element at the specified position. Shifts the element currently at that
	 * position (if any) and any subsequent elements to the right (adds one to their indices).
	 *
	 * @param index The index at which the specified element is to be inserted
	 * @param element The element to be inserted
	 * @throws IndexOutOfBoundsException if the specified index is larger than the last position
	...
	/**
	 * Inserts a <CODE>PdfObject</CODE> at the beginning of the <CODE>PdfArray</CODE>. The
	 * <CODE>PdfObject</CODE> will be the first element, any other elements will be shifted to the
	...
	/**
	 * Returns a <CODE>PdfObject</CODE> as a <CODE>PdfDictionary</CODE>, resolving indirect
