...
class PdfStamperImp extends PdfWriter {
	...
	void close(HashMap moreInfo) throws IOException {
		...
		PdfObject fileID = PdfEncryption.createInfoId(PdfEncryption.createDocumentId());
	...
	/**
	 * Additional-actions defining the actions to be taken in response to various trigger events
	 * affecting the document as a whole. The actions types allowed are:
	 * <CODE>DOCUMENT_CLOSE</CODE>, <CODE>WILL_SAVE</CODE>, <CODE>DID_SAVE</CODE>,
	 * <CODE>WILL_PRINT</CODE> and <CODE>DID_PRINT</CODE>.
	 *
