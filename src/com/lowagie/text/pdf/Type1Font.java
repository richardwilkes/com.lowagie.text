...
class Type1Font extends BaseFont {
	...
	/**
	 * The font's encoding name. This encoding is 'StandardEncoding' or 'AdobeStandardEncoding' for
	 * a font that can be totally encoded according to the characters names. For all other names the
	...
	/**
	 * Represents the section CharMetrics in the AFM file. Each value of this array contains a
	 * <CODE>Object[4]</CODE> with an Integer, Integer, String and int[]. This is the code, width,
	 * name and char bbox. The key is the name of the char and also an Integer with the char number.
	 */
	 ...
	 * and the value is a <CODE>Object[]</CODE> with 2 elements for each kern pair. Position 0 is
	 * the name of the second character and position 1 is the kerning distance. This is repeated for
	 * all the pairs.
	 */
	...
	/**
	 * Types of records in a PFB file. ASCII is 1 and BINARY is 2. They have to appear in the PFB
	...
	/**
	 * Gets the width from the font according to the <CODE>name</CODE> or, if the <CODE>name</CODE>
	 * is null, meaning it is a symbolic font, the char <CODE>c</CODE>.
	 * 
	...
	/**
	 * Gets the kerning between two Unicode characters. The characters are converted to names and
	 * this names are used to find the kerning pairs in the <CODE>HashMap</CODE>
	 * <CODE>KernPairs</CODE>.
	 * 
	...
	/**
	 * Generates the font descriptor for this font or <CODE>null</CODE> if it is one of the 14 built
	 * in fonts.
	 * 
	 * @param fontStream the indirect reference to a PdfStream containing the font or
	 *            <CODE>null</CODE>
	 ...
	 * @param shortTag a 256 bytes long <CODE>byte</CODE> array where each unused byte is
	 *            represented by 0
	 * @param fontDescriptor the indirect reference to a PdfDictionary containing the font
	 ...
	 * <CODE>ASCENT</CODE>, <CODE>CAPHEIGHT</CODE>, <CODE>DESCENT</CODE>, <CODE>ITALICANGLE</CODE>,
	 * <CODE>BBOXLLX</CODE>, <CODE>BBOXLLY</CODE>, <CODE>BBOXURX</CODE> and <CODE>BBOXURY</CODE>.
	 * 
