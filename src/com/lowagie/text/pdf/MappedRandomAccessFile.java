...
public class MappedRandomAccessFile {
	...
	public MappedRandomAccessFile(String filename, String mode) throws FileNotFoundException, IOException {
		...
		if (mode.equals("rw")) {
			init(new java.io.RandomAccessFile(filename, mode).getChannel(), FileChannel.MapMode.READ_WRITE);
		} else {
	...
	/**
	 * @see java.io.RandomAccessFile#close() Cleans the mapped bytebuffer and closes the channel
	 */
