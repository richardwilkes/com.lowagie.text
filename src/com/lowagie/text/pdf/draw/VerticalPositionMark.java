...
/**
 * Helper class implementing the DrawInterface. Can be used to add horizontal or vertical
 * separators. Won't draw anything unless you implement the draw method.
 * 
 * @since 2.1.2
 */
...
public class VerticalPositionMark implements DrawInterface, Element {
	...
	/**
	 * Another implementation of the DrawInterface; its draw method will overrule
	 * LineSeparator.draw().
	 */
	...
	/**
	 * @see com.lowagie.text.pdf.draw.DrawInterface#draw(com.lowagie.text.pdf.PdfContentByte, float,
	...
	/**
	 * Setter for the offset. The offset is relative to the current Y position. If you want to
	 * underline something, you have to choose a negative offset.
	 * 
